...
Um projeto desenvolvido inteiramente através da linguagem JAVA, afim de, rodar diretamente pelo terminal(sem uma interface para front-end). <br>
...
<br> <br>
<img src="image/thumb-java.png" alt="Foto do projeto" width="1000">
